...
function legacyPage({ title, date, content, download }) {
  ...
  return `<!doctype html>
<html lang="zh-CN">
<head><meta charset="UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1" /><meta name="theme-color" content="#000000" /><meta name="mobile-web-app-capable" content="yes" /><meta name="apple-mobile-web-app-capable" content="yes" /><meta name="apple-mobile-web-app-status-bar-style" content="black-translucent" /><meta name="apple-mobile-web-app-title" content="OUART MODEL" /><title>${escapeHtml(title)}｜OUART MODEL</title><link rel="icon" href="../../assets/favicon-32.png" type="image/png" sizes="32x32" /><link rel="shortcut icon" href="../../favicon.ico" /><link rel="apple-touch-icon" href="../../assets/apple-touch-icon.png" sizes="180x180" /><link rel="manifest" href="../../site.webmanifest" /><link rel="stylesheet" href="../../styles.css" /></head>
<body>
<header class="site-header"><a class="brand" href="../../index.html" aria-label="OUART MODEL 首页"><img class="brand-mark" src="../../assets/logo-mark.png" alt="" width="42" height="42" /><span class="brand-copy"><strong>OUART MODEL</strong><span>初艺模型分享</span></span></a><button class="menu-button" type="button" aria-expanded="false" aria-controls="site-nav"><span></span><span></span><span></span><span class="sr-only">打开导航</span></button><nav id="site-nav" class="site-nav" aria-label="主导航"><a href="../../index.html#latest">最新模型</a><a class="active" href="../../index.html#archive">全部模型</a><a href="../../index.html#guide">使用说明</a></nav></header>
