...
assert.equal(models.filter((model) => model.published === true).length, 147);
assert.equal(models.find((model) => model.published === true && model.id && model.image).id, 'sitting-ghost');
